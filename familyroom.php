...
<head>
  ...
  <title>For Rent : Family Rooms</title>

  <link rel="stylesheet" href="/rent project/css/familyroom.css">
</head>
...
<body class="text-primary bg-light">
  ...
  <div class="container my-4">
    ...
    <div class="alert alert-primary my-4" role="alert">
      Let's have a look at Family Room's
    </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>1 BHK Room's</td>
              <td>It Provides enough space for comfort</td>
              <!-- <td>@mdo</td> -->
            </tr>
            <tr>
              <th scope="row">2</th>
