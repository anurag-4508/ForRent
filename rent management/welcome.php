...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] != true) {
    header("location: /rent project/ownerlogin.php");
    exit;
}
?>
...
<body>
    ...
    <div class="container my-4">
        <div class="alert alert-success" role="alert">
            ...
            <hr>
            <p class="mb-0">Whenever you need to, be sure to logout <a href="/rent project/rent management/_logout.php"> using this link</a></p>
        </div>
